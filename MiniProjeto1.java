...
public class MiniProjeto1 {
    public static void  main(String[] args) throws Exception {
        ...
        else if(esqDire.equals("direita")||esqDire.equals("Direita")){
            System.out.println("Após seguir por muito tempo no caminho da direita o gatinho ver um rio que sebpara a floresta da cidade. Qual caminho o gato irá seguir? Atraversar o rio ou tentar buscar outro caminho?");
            String RioCaminho = x.nextLine();
                if(RioCaminho.equals("atravesar o rio")){
